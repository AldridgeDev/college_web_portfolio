...
$.fn.ycp = function(j) {
    ...
    function ycp_list(h, f, g, k, l) {
        $.ajax({
            ...
            var d = '';
            d += '<div class="luhur">';
            d += '<div class="title">' + h + '</a></div>';
            d += '<span class="tombol vid-prev" title="Previous videos"><u>Previous</u></span>';
            d += '<span class="tombol vid-nav"  title="Playlist Navigation">Playlist&nbsp;Navigation</span>';
            d += '<span class="tombol vid-next" title="Next videos"><u>Next</u></span><span class="about" title="ycp.js"></span></div><div class="handap">';
